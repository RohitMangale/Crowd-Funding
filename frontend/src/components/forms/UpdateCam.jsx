...
import getCampaginData from '../../hooks/useFetchData';
...
const UpdateCam = () => {
    ...
    const {data:campaignData,loading: loadingPrev,error} = getCampaginData(`${BASE_URL}/fundraisers/campaigns/${id}`);
  ...
  useEffect(() => {    
    setFormData({title:campaignData.title,tagline:campaignData.tagline,goal:campaignData.goal,desc:campaignData.desc,photo:campaignData.photo,type:campaignData.type,category:campaignData.category});
  },[campaignData]);
  ...
  const submitHandler = async (event) => {
    ...
    try {
      const res = await fetch(`${BASE_URL}/fundraisers/campaigns/${id}`, {
        method: "put",
        headers: {
